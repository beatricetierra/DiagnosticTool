...
def Diagnostic(filenames):
    ...
    # Get kvct_df and kvct_filtered
    kvct_interlocks, kvct_filtered = idf.kvct_df(kvct_log, sys_log, kvct_start_times)
    
    analysis_df = dts.analysis(kvct_filtered)
    
    return(kvct_interlocks, kvct_filtered, analysis_df)
